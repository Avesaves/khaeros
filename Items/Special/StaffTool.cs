...
namespace Server.Items
{
        ...
        public override void OnDoubleClick(Mobile from)
        {
            ...
            if (from is PlayerMobile)
            {
                ...
                if (player != null)
                {
                    ...
                    if (DateTime.Now < LastClicked + TimeSpan.FromSeconds(1.0))
                    {
                        if (!HideEffects)
    ...
    public class StaffToolGump : Gump
    {
            ...
            : base(0, 0)
        {
            ...
            AddPage(1);
            AddBackground(0, 0, 210, 255, 9200);
            ...
            AddLabel(80, 160, 62, @"GameMaster");
            AddLabel(80, 190, 62, @"Administrator");
            AddLabel(80, 220, 62, @"Owner");
