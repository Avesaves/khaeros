...
namespace Server.Items
{
	...
	public class ElegantCloak : BaseCloak
	{
		[Constructable]
		public ElegantCloak() : this( 0 )
		{
		}

		[Constructable]
		public ElegantCloak( int hue ) : base( 0x3C48, hue )
		{
			Weight = 2.0;
			Name = "Elegant Cloak";
		}

		public ElegantCloak( Serial serial ) : base( serial )
		{
		}
	...
	public class ExpensiveCloak : BaseCloak
	{
		[Constructable]
		public ExpensiveCloak() : this( 0 )
		{
		}

		[Constructable]
		public ExpensiveCloak( int hue ) : base( 0x3C67, hue )
		{
			Weight = 2.0;
			Name = "Expensive Cloak";
		}

		public ExpensiveCloak( Serial serial ) : base( serial )
		{
		}
	...
	public class RunicCloak : BaseCloak
	{
		[Constructable]
		public RunicCloak() : this( 0 )
		{
		}

		[Constructable]
		public RunicCloak( int hue ) : base( 0x3C4E, hue )
		{
			Weight = 2.0;
			Name = "Runic Cloak";
		}
