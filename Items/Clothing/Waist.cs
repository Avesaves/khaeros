...
namespace Server.Items
{
	...
	public class SmallBeltPouch : BaseWaist
	{
		[Constructable]
		public SmallBeltPouch() : this( 0 )
		{
		}

		[Constructable]
		public SmallBeltPouch( int hue ) : base( 0x2C86, hue )
		{
			Name = "small belt pouch";
			Weight = 1.0;
		}

		public SmallBeltPouch( Serial serial ) : base( serial )
		{
		}
	...
	public class BeltPouch : BaseWaist
	{
		[Constructable]
		public BeltPouch() : this( 0 )
		{
		}

		[Constructable]
		public BeltPouch( int hue ) : base( 0x2C8C, hue )
		{
			Weight = 1.0;
			Name = "belt pouch";
		}

		public BeltPouch( Serial serial ) : base( serial )
		{
		}
