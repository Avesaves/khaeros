...
{
	public abstract class BaseClothMaterial : Item
	{
		...
		private class PickLoomTarget : Target
		{
			...
			protected override void OnTarget( Mobile from, object targeted )
			{
				...
				if ( loom != null )
				{
					...
					{
						if( m_Material.Hue == loom.LastHue || loom.Phase == 0 )
						{
							loom.LastHue = m_Material.Hue;
						...
						{
							from.SendMessage( "That loom has already started being used with a different sort of fabric material." );
							return;
						}
					}
					else
