...
namespace Server.Items
{
		...
		public override int LabelNumber
		{
			get
			{
				if ( m_Resource >= CraftResource.ThickLeather && m_Resource <= CraftResource.ScaledLeather )
					return 1049684 + (int)(m_Resource - CraftResource.ThickLeather);
	...
	[FlipableAttribute( 0x1081, 0x1082 )]
	public class ThickLeather : BaseLeather
	{
		[Constructable]
		public ThickLeather() : this( 1 )
		{
		}

		[Constructable]
		public ThickLeather( int amount ) : base( CraftResource.ThickLeather, amount )
		{
		}

		public ThickLeather( Serial serial ) : base( serial )
		{
		}
	...
	[FlipableAttribute( 0x1081, 0x1082 )]
	public class BeastLeather : BaseLeather
	{
		[Constructable]
		public BeastLeather() : this( 1 )
		{
		}

		[Constructable]
		public BeastLeather( int amount ) : base( CraftResource.BeastLeather, amount )
		{
		}

		public BeastLeather( Serial serial ) : base( serial )
		{
		}
	...
	public class ScaledLeather : BaseLeather
	{
		...
		[Constructable]
		public ScaledLeather( int amount ) : base( CraftResource.ScaledLeather, amount )
		{
		}
