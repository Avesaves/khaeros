...
{
	public class VhalurianOrnatePlateHelm : BaseArmor
	{
		...
		[Constructable]
		public VhalurianOrnatePlateHelm() : base( 0x3B16 )
		{
			Weight = 5.0;
			Name = "Vhalurian Ornate Plate Helm";
		}

		public VhalurianOrnatePlateHelm( Serial serial ) : base( serial )
		{
		}
