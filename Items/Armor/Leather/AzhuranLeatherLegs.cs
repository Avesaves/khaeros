...
{
	public class AzhuranLeatherLegs : BaseArmor
	{
		...
		[Constructable]
		public AzhuranLeatherLegs() : base( 0x3BF0 )
		{
			Weight = 4.0;
			Name = "Azhuran Leather Legs";
		}

		public AzhuranLeatherLegs( Serial serial ) : base( serial )
		{
		}
