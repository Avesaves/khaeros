...
{
	public class SplintedMailGorget : BaseArmor
	{
		...
		[Constructable]
		public SplintedMailGorget() : base( 0x3BDC )
		{
			Weight = 2.0;
			Name = "splinted mail Gorget";
		}

		public SplintedMailGorget( Serial serial ) : base( serial )
		{
		}
