...
{
	public class AlyrianChainGorget : BaseArmor
	{
		...
		[Constructable]
		public AlyrianChainGorget() : base( 0x3BDC )
		{
			Weight = 2.0;
			Name = "Alyrian Chain Gorget";
		}

		public AlyrianChainGorget( Serial serial ) : base( serial )
		{
		}
