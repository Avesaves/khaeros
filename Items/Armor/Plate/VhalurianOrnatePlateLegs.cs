...
{
	public class VhalurianOrnatePlateLegs : BaseArmor
	{
		...
		[Constructable]
		public VhalurianOrnatePlateLegs() : base( 0x1411 )
		{
			Weight = 7.0;
			Name = "Vhalurian Ornate Plate Legs";
		}

		public VhalurianOrnatePlateLegs( Serial serial ) : base( serial )
		{
		}
