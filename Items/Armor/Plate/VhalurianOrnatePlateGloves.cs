...
{
	public class VhalurianOrnatePlateGloves : BaseArmor
	{
		...
		[Constructable]
		public VhalurianOrnatePlateGloves() : base( 0x3B1B )
		{
			Weight = 2.0;
			Name = "Vhalurian Ornate Plate Gloves";
		}

		public VhalurianOrnatePlateGloves( Serial serial ) : base( serial )
		{
		}
