...
{
	public class OrnatePlateGorget : BaseArmor
	{
		...
		[Constructable]
		public OrnatePlateGorget() : base( 0x3B1C )
		{
			Weight = 2.0;
			Name = "ornate Plate Gorget";
			Layer = Layer.Neck;
		}

		public OrnatePlateGorget( Serial serial ) : base( serial )
		{
		}
