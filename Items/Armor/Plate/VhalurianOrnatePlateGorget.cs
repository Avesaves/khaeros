...
{
	public class VhalurianOrnatePlateGorget : BaseArmor
	{
		...
		[Constructable]
		public VhalurianOrnatePlateGorget() : base( 0x3B1C )
		{
			Weight = 2.0;
			Name = "Vhalurian Ornate Plate Gorget";
			Layer = Layer.Neck;
		}

		public VhalurianOrnatePlateGorget( Serial serial ) : base( serial )
		{
		}
