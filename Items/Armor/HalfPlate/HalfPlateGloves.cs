...
namespace Server.Items
{
	...
	public class TyreanHalfPlateGloves : BaseArmor
	{
		...
		[Constructable]
		public TyreanHalfPlateGloves() : base( 0x2B0C )
		{
			Weight = 2.0;
			Name = "Tyrean Half-Plate Gloves";
		}

		public TyreanHalfPlateGloves( Serial serial ) : base( serial )
		{
		}
