...
{
	public class KhemetarScaleArms : BaseArmor
	{
		...
		[Constructable]
		public KhemetarScaleArms() : base( 0x3BD1 )
		{
			Weight = 15.0;
			Name = "Khemetar Scale Arms";
		}

		public KhemetarScaleArms( Serial serial ) : base( serial )
		{
		}
