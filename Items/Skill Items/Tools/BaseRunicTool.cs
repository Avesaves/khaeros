...
namespace Server.Items
{
	public abstract class BaseRunicTool : BaseTool
	{
		...
		{
			int fire, phys, cold, nrgy, pois, blut, slax, pirc;

			weapon.GetDamageTypes( null, out phys, out fire, out cold, out pois, out nrgy, out blut, out slax, out pirc );
			...
			AosElementAttribute[] attrs = new AosElementAttribute[]
			{
                ...
                AosElementAttribute.Blunt,
                AosElementAttribute.Slashing,
                AosElementAttribute.Piercing
			};
