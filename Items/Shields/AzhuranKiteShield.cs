...
{
	public class AzhuranKiteShield : BaseShield
	{
		...
		[Constructable]
		public AzhuranKiteShield() : base( 0x3D2F )
		{
			Weight = 8.0;
			Name = "Azhuran Kite Shield";
		}

		public AzhuranKiteShield( Serial serial ) : base(serial)
		{
		}
