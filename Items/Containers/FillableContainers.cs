...
namespace Server.Items
{
	...
	[Flipable( 0xA97, 0xA99, 0xA98, 0xA9A, 0xA9B, 0xA9C, 0x2F7, 0x2F8 )]
	public class LibraryBookcase : FillableContainer, ICanBeStained
	{
	...
	public class FillableLargeCrate : FillableContainer, ICanBeStained
	{
		[Constructable]
	...
	public class FillableSmallCrate : FillableContainer, ICanBeStained
	{
		[Constructable]
	...
	public class FillableWoodenBox : FillableContainer, ICanBeStained
	{
		[Constructable]
	...
	public class FillableMetalBox : FillableContainer, ICanBeStained
	{
		[Constructable]
	...
	public class FillableBarrel : FillableContainer, ICanBeStained
	{
		public override bool IsLockable{ get{ return false; } }
	...
	public class FillableWoodenChest : FillableContainer, ICanBeStained
	{
		[Constructable]
	...
	public class FillableContent
	{
		...
		public static FillableContent ArtisanGuild = new FillableContent(
			...
			new FillableEntry[]
			{
				...
				new FillableEntry( 1, typeof( BeastTribalMask ) )
			} );
