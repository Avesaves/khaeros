...
namespace Server.Items
{
	...
	public class ClericCrook : BaseStaff
	{
		//public override WeaponAbility PrimaryAbility{ get{ return WeaponAbility.CrushingBlow; } }
		//public override WeaponAbility SecondaryAbility{ get{ return WeaponAbility.Disarm; } }
		public override string NameType { get { return "Cleric's Crook"; } }
		...
		public ClericCrook( Serial serial ) : base( serial )
		{
		}
		...
		private class HerdingTarget : Target
		{
			...
			private class InternalTarget : Target
			{
				...
				protected override void OnTarget( Mobile from, object targ )
				{
					if ( targ is IPoint2D )
					{
						if ( from.CheckTargetSkill( SkillName.AnimalHusbandry, m_Creature, 0, 100 ) )
						{
