...
{
	/// <summary>
	/// A quick attack to all enemies in range of your weapon that causes damage over time. Requires Bushido or ExoticWeaponry skill.
	/// </summary>
	public class FrenziedWhirlwind : WeaponAbility
	{
		...
		public override void OnHit( Mobile attacker, Mobile defender, int damage )
		{
			...
			if( targets.Count > 0 )
			{
				...
				// 5-15 damage
				int amount = (int)(10.0 * ((Math.Max( attacker.Skills[SkillName.Leadership].Value, attacker.Skills[SkillName.ExoticWeaponry].Value ) - 50.0) / 70.0 + 5));
