...
namespace Server.Items
{
	...
	public class Feint : WeaponAbility
	{
		...
		public override void OnHit( Mobile attacker, Mobile defender, int damage )
		{
			...
			Timer t = new FeintTimer( defender, (int)(20.0 + 3.0 * (Math.Max( attacker.Skills[SkillName.ExoticWeaponry].Value, attacker.Skills[SkillName.Leadership].Value ) - 50.0) / 7.0) );	//20-50 % decrease
