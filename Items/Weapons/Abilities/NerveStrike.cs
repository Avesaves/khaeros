...
namespace Server.Items
{
	...
	public class NerveStrike : WeaponAbility
	{
		...
		{
			if( GetSkill( from, SkillName.Leadership ) < 50.0 )
			{
		...
		public override void OnHit( Mobile attacker, Mobile defender, int damage )
		{
			...
			AOS.Damage( defender, attacker, (int)(15.0 * (attacker.Skills[SkillName.Leadership].Value - 50.0) / 70.0 + 10), 100, 0, 0, 0, 0, 0, 0, 0 );	//10-25
