	...
	public abstract class WeaponAbility
	{
		...
		public virtual int CalculateMana( Mobile from )
		{
			...
			double skillTotal = GetSkill( from, SkillName.Swords ) + GetSkill( from, SkillName.Macing )
				...
				+ GetSkill( from, SkillName.Poisoning ) + GetSkill( from, SkillName.Leadership ) + GetSkill( from, SkillName.ExoticWeaponry );
		...
		public virtual bool Validate( Mobile from )
		{
			...
			if ( Spells.Bushido.HonorableExecution.IsUnderPenalty( from ) || Spells.ExoticWeaponry.AnimalForm.UnderTransformation( from ) )
			{
