...
{
	/// <summary>
	/// Raises your defenses for a short time. Requires Bushido or ExoticWeaponry skill.
	/// </summary>
	public class Block : WeaponAbility
	{
		...
		public override void OnHit( Mobile attacker, Mobile defender, int damage )
		{
			...
			int bonus = (int)(10.0 * ((Math.Max( attacker.Skills[SkillName.Leadership].Value, attacker.Skills[SkillName.ExoticWeaponry].Value ) - 50.0) / 70.0 + 5));
