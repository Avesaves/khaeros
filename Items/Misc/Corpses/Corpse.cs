...
namespace Server.Items
{
	public class Corpse : Container, ICarvable
	{
		...
		{
			get{ return m_NoDecaying; }
			set{ m_NoDecaying = value; }
		}
		...
		public override void Serialize( GenericWriter writer )
		{
			...
			writer.Write( (bool) m_NoDecaying );
