...
{
	public class Bola : Item, IEasyCraft
	{
		[Constructable]
		public Bola() : this( 1 )
		{
		...
		private static void FinishThrow( object state )
		{
			...
			Misc.Dismount.DismountCheck( from, to, 20, SkillName.Tactics, ((IKhaerosMobile)from).Feats.GetFeatLevel(FeatList.NonLethalTraps) );
