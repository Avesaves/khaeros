...
namespace Server
{
	public class Loot
	{
		...
		private static Type[] m_SEWeaponTypes = new Type[]
			{
				typeof( Bokuto ),				typeof( Daisho ),				typeof( DualPicks ),
				typeof( Lajatang ),				typeof( NoDachi ),				typeof( Nunchaku ),
				typeof( DualDaggers ),					typeof( Claws ),				typeof( Tessen ),
				typeof( SpikedClub ),				typeof( Wakizashi )
			};
		...
		private static Type[] m_SEClothingTypes = new Type[]
			{
				typeof( FeElegantRobe ),			typeof( Hakama ),
				typeof( HakamaShita ),			typeof( JinBaori ),				typeof( Kamishimo ),
				typeof( ElegantRobe ),			typeof( NinjaTabi ),			typeof( Obi ),
		...
		private static Type[] m_ClothingTypes = new Type[]
			{
				...
				typeof( TricorneHat ),			typeof( WideBrimHat ),          typeof( TallBrimHat ),
		...
		private static Type[] m_HatTypes = new Type[]
			{
				...
				typeof( TallStrawHat ),		typeof( TallBrimHat ),	typeof( Bonnet ),
		...
		{
			if ( Core.SE && inTokuno )
				return Construct( m_SEWeaponTypes, m_AosWeaponTypes, m_WeaponTypes, m_AosRangedWeaponTypes, m_RangedWeaponTypes, m_ArmorTypes, m_SEHatTypes, m_AosHatTypes, m_HatTypes, m_AosShieldTypes, m_ShieldTypes );
		...
		{
			if ( Core.SE && inTokuno )
				return Construct( m_SEWeaponTypes, m_AosWeaponTypes, m_WeaponTypes, m_SERangedWeaponTypes, m_AosRangedWeaponTypes, m_RangedWeaponTypes, m_ArmorTypes, m_SEHatTypes, m_AosHatTypes, m_HatTypes, m_AosShieldTypes, m_ShieldTypes, m_JewelryTypes );
