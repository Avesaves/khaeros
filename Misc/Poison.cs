...
namespace Server
{
	public class PoisonImpl : Poison
	{
		...
		public static void Configure()
		{
			if ( Core.AOS )
			{
				Register( new PoisonImpl( "Lesser",		0,  1, 2,  7.5, 5.0, 2.25, 5, 4 ) );
				Register( new PoisonImpl( "Regular",	1,  2, 4, 10.0, 5.0, 3.25, 5, 3 ) );
				Register( new PoisonImpl( "Greater",	2, 4, 6, 15.0, 5.0, 4.25, 5, 2 ) );
				Register( new PoisonImpl( "Deadly",		3, 6, 8, 30.0, 5.0, 5.25, 5, 2 ) );
				Register( new PoisonImpl( "Lethal",		4, 8, 10, 35.0, 5.0, 5.25, 5, 2 ) );
			}
			else
			{
		...
		public class PoisonTimer : Timer
		{
			...
			protected override void OnTick()
			{
				...
				AOS.Damage( m_Mobile, m_From, damage, 0, 0, 0, 100, 0, 0, 0, 0 );
