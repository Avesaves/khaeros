...
namespace Server.Gumps
{
	public class WhoGump : Gump
	{
		...
		{
			CommandSystem.Register( "Who", AccessLevel.GameMaster, new CommandEventHandler( WhoList_OnCommand ) );
			CommandSystem.Register( "WhoList", AccessLevel.GameMaster, new CommandEventHandler( WhoList_OnCommand ) );
		}
