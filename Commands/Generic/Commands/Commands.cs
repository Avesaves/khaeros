...
namespace Server.Commands.Generic
{
	public class TargetCommands
	{
		public static void Initialize()
		{
			...
			Register( new AliasedSetCommand( AccessLevel.Counselor, "Invul", "blessed", "true", ObjectTypes.Mobiles ) );
			Register( new AliasedSetCommand( AccessLevel.GameMaster, "Mortal", "blessed", "false", ObjectTypes.Mobiles ) );
			Register( new AliasedSetCommand( AccessLevel.Counselor, "NoInvul", "blessed", "false", ObjectTypes.Mobiles ) );
			...
			Register( new ForceDismountCommand() );
	...
	public class ForceDismountCommand : BaseCommand
	{
		public ForceDismountCommand()
		{
			AccessLevel = AccessLevel.GameMaster;
			Supports = CommandSupport.AllMobiles;
			Commands = new string[]{ "ForceDismount" };
			ObjectTypes = ObjectTypes.Mobiles;
			Usage = "ForceDismount";
