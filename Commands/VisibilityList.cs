...
namespace Server.Commands
{
	public class VisibilityList
	{
		public static void Initialize()
		{
			...
			CommandSystem.Register( "Vis", AccessLevel.Player, new CommandEventHandler( Vis_OnCommand ) );
			CommandSystem.Register( "VisList", AccessLevel.Player, new CommandEventHandler( VisList_OnCommand ) );
			CommandSystem.Register( "VisClear", AccessLevel.Player, new CommandEventHandler( VisClear_OnCommand ) );
		}
		...
		private class VisTarget : Target
		{
			...
			protected override void OnTarget( Mobile from, object targeted )
			{
				if ( from is PlayerMobile && targeted is Mobile )
				{
					...
					if ( targ.AccessLevel < from.AccessLevel || from.AccessLevel == AccessLevel.Player )
					{
						List<Mobile> list = pm.VisibilityList;
