...
*/
/*
 * Emote v5 by Khagroth
 * Translated to English and made a few small changes to the emotes
 * (Faint uses .liedown, puke lasts longer.)
 */
using System;
...
namespace Server.Scripts.Commands
{
    ...
    public class EmoteGump : Gump
    {
            ...
            : base(600, 50)
        {
            ...
            AddLabel(13, 70, 200, "Sound Emotes");
            ...
            switch (page)
            {
                case EmotePage.P1:
                    {
                        ...
                        AddButtonLabeled(10, 165, GetButtonID(1, 4), "blownose");
                        AddButtonLabeled(10, 190, GetButtonID(1, 5), "bow");
                        AddButtonLabeled(10, 215, GetButtonID(1, 6), "bscough");
                        AddButtonLabeled(10, 240, GetButtonID(1, 7), "burp");
                        AddButtonLabeled(10, 265, GetButtonID(1, 8), "clearthroat");
                ...
                case EmotePage.P3:
                    {
                        ...
                        AddButtonLabeled(10, 365, GetButtonID(1, 36), "stickouttongue");
                ...
                case EmotePage.P4:
                    {
                        AddButtonLabeled(10, 90, GetButtonID(1, 37), "tapfoot");
