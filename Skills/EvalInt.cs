		...
		private class InternalTarget : Target
		{
			...
			protected override void OnTarget( Mobile from, object targeted )
			{
				...
				else if ( targeted is Mobile )
				{
					...
					int marginOfError = Math.Max( 0, 20 - (int)(from.Skills[SkillName.Invocation].Value / 5) );
					...
					if ( from.CheckTargetSkill( SkillName.Invocation, targ, 0.0, 120.0 ) )
					{
						...
						if ( from.Skills[SkillName.Invocation].Base >= 76.0 )
