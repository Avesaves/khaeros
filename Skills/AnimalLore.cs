...
namespace Server.SkillHandlers
{
	...
	public class AnimalLoreGump : Gump
	{
		...
		public AnimalLoreGump( BaseCreature c ) : base( 250, 50 )
		{
			...
			AddHtmlLocalized( 153, 168, 160, 18, 1044103, LabelColor, false, false ); // UnarmedFighting
			AddHtml( 320, 168, 35, 18, FormatSkill( c, SkillName.UnarmedFighting ), false, false );
			...
			AddHtml( 320, 294, 35, 18,FormatSkill( c, SkillName.Invocation ), false, false );
