	...
	public class TirebladdGuard : BaseKhaerosMobile, IRacialGuard, ITirebladd
	{
        ...
        private String RandomAttackSpeech()
        {
            ...
            if (DateTime.Now >= (m_speechInterval + TimeSpan.FromSeconds(30)))
            {
                ...
                {
                    case 1: { m_speechInterval = DateTime.Now; return "For the fatherland, forward!"; }
                    case 2: { m_speechInterval = DateTime.Now; return "Remember Tyris!"; }
                    case 3: { m_speechInterval = DateTime.Now; return "Stop right there, criminal scum!"; }
                    case 4: { m_speechInterval = DateTime.Now; return "Cut them down, sons of the north!"; }
                    case 5: { m_speechInterval = DateTime.Now; return "Fire at your balls!"; }
                    case 6: { m_speechInterval = DateTime.Now; return "Follow me, heroes!"; }
                    case 7: { m_speechInterval = DateTime.Now; return "Unworthy swine."; }
                    case 8: { m_speechInterval = DateTime.Now; return "Beardless fool!"; }
                }
            }
