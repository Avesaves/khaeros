	...
	public class NorthernGuard : BaseKhaerosMobile, IRacialGuard, INorthern
	{
        ...
        private String RandomAttackSpeech()
        {
            ...
            if (DateTime.Now >= (m_speechInterval + TimeSpan.FromSeconds(30)))
            {
                ...
                {
                    case 1: { m_speechInterval = DateTime.Now; return "Awake the iron!"; }
                    case 2: { m_speechInterval = DateTime.Now; return "Long live Vhaluran!"; }
                    case 3: { m_speechInterval = DateTime.Now; return "Stop right there, criminal scum!"; }
                    case 4: { m_speechInterval = DateTime.Now; return "Charge, my brothers!"; }
                    case 5: { m_speechInterval = DateTime.Now; return "For the Captain!"; }
                    case 6: { m_speechInterval = DateTime.Now; return "To arms, to arms!"; }
                    case 7: { m_speechInterval = DateTime.Now; return "Halfborn bastard of a Mhordul!"; }
                    case 8: { m_speechInterval = DateTime.Now; return "*snooore... snr-rr-snort?!*"; }
                }
            }
