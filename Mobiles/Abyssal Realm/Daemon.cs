...
namespace Server.Mobiles
{
	...
	public class Daemon : BaseCreature
	{
		...
		public Daemon () : base( AIType.AI_Mage, FightMode.Closest, 10, 1, 0.2, 0.4 )
		{
			...
			SetResistance( ResistanceType.Blunt, 45, 60 );
			SetResistance( ResistanceType.Piercing, 45, 60 );
			SetResistance( ResistanceType.Slashing, 45, 60 );
			SetResistance( ResistanceType.Fire, 50, 60 );
			SetResistance( ResistanceType.Cold, 30, 40 );
			SetResistance( ResistanceType.Poison, 20, 30 );
			SetResistance( ResistanceType.Energy, 30, 40 );

			SetSkill( SkillName.Invocation, 70.1, 80.0 );
