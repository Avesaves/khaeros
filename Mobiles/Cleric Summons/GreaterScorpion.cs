...
namespace Server.Mobiles
{
	...
	public class GreaterScorpion : BaseCreature, IClericSummon
	{
		[Constructable]
		public GreaterScorpion() : base( AIType.AI_Melee, FightMode.Closest, 10, 1, 0.4, 0.8 )
		{
		...
		public GreaterScorpion( Serial serial ) : base( serial )
		{
		}
