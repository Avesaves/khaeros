...
namespace Server.Mobiles
{
	...
	public class ClericScorpion : BaseCreature, IUndead, IClericSummon
	{
		[Constructable]
		public ClericScorpion() : base( AIType.AI_Melee, FightMode.Closest, 10, 1, 0.4, 0.8 )
		{
			Name = "a Scorpion";
            Body = 48;
            BaseSoundID = 397;
		...
		public ClericScorpion( Serial serial ) : base( serial )
		{
		}
