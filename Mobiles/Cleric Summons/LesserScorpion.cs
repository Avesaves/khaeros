...
namespace Server.Mobiles
{
	...
	public class LesserScorpion : BaseCreature, IClericSummon
	{
		[Constructable]
		public LesserScorpion() : base( AIType.AI_Melee, FightMode.Closest, 10, 1, 0.4, 0.8 )
		{
		...
		public LesserScorpion( Serial serial ) : base( serial )
		{
		}
