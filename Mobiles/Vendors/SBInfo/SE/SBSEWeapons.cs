	...
	public class SBSEWeapons: SBInfo
	{
		...
		public class InternalBuyInfo : ArrayList
		{
			public InternalBuyInfo()
			{
				...
				Add( new GenericBuyInfo( typeof( Claws ), 55, 20, 0x27AB, 0 ) );
				Add( new GenericBuyInfo( typeof( Shuriken ), 18, 20, 0x27AC, 0 ) );
				Add( new GenericBuyInfo( typeof( DualPicks ), 61, 20, 0x27AD, 0 ) );
				Add( new GenericBuyInfo( typeof( DualDaggers ), 56, 20, 0x27AF, 0 ) );		
		...
		public class InternalSellInfo : GenericSellInfo
		{
			public InternalSellInfo()
			{
				...
				Add( typeof( DualPicks ), 30 );
				Add( typeof( DualDaggers ), 28 );
			}
		}
	}
}
