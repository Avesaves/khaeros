...
{
	[CorpseName( "a formian corpse" )]
	public class FormianWorker : BaseCreature, IMediumPredator, IFormian
	{
		[Constructable]
		public FormianWorker() : base( AIType.AI_Melee, FightMode.Closest, 10, 1, 0.2, 0.4 )
		{
			Name = "a formian worker";
			Body = 805;
			BaseSoundID = 959;
			Hue = 0;
