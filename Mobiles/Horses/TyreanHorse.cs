...
namespace Server.Mobiles
{
    ...
    {
        private RuganHorse m_Horse;

        public WarHorseAttackTimer(RuganHorse h) : base(System.TimeSpan.FromSeconds(1), System.TimeSpan.FromMinutes(Utility.RandomMinMax(1,3)))
        {
            m_Horse = h;
        ...
        private static bool DirectionCheck(RuganHorse h, Mobile m)
        {
