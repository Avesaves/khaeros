...
namespace Server.Mobiles
{
	...
	public class WorkHorse : BaseBreedableCreature, ILargePrey
	{
		public override bool ParryDisabled{ get{ return true; } }
		[Constructable]
		public WorkHorse() : base( AIType.AI_Animal, FightMode.Aggressor, 10, 1, 0.2, 0.4 )
		{
			Name = "a work horse";
			Body = 291;
			BaseSoundID = 0xA8;
		...
		public WorkHorse( Serial serial ) : base( serial )
		{
		}
		
		public override void PrepareToGiveBirth()
		{
			GiveBirth( new WorkHorse() );
		}
