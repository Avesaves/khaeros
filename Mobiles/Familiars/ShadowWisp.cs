...
namespace Server.Mobiles
{
	...
	public class WanderingSpiritFamiliar : BaseFamiliar
	{
		public WanderingSpiritFamiliar()
		{
			Name = "a shadow wisp";
			Body = 165;
			Hue = 0x901;
			...
			SetSkill( SkillName.UnarmedFighting, 40.0 );
		...
		public WanderingSpiritFamiliar( Serial serial ) : base( serial )
		{
		}
