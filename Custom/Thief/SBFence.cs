...
namespace Server.Mobiles
{
    ...
    public class InternalSellInfo : GenericSellInfo
    {
        ...
        public InternalSellInfo()
        {
            ...
            Add(typeof(VhalurianRepeatingCrossbow), 12);
            ...
            Add(typeof(TyreanDoubleAxe), 6);
            Add(typeof(AzhuranAxe), 4);
            ...
            Add(typeof(KhemetarScimitar), 6);
            Add(typeof(ThinLongsword), 3);
            Add(typeof(TyreanBroadsword), 7);
            Add(typeof(Scythe), 7);
            Add(typeof(HandScythe), 2);
            Add(typeof(MhordulScepter), 3);
            Add(typeof(AzhuranBladedStaff), 6);
            Add(typeof(Pike), 9);
            Add(typeof(DoubleBladedStaff), 7);
            Add(typeof(VhalurianLance), 11);
            Add(typeof(MhordulCrescentBlade), 8);
            ...
            Add(typeof(VhalurianMetalKiteShield), 6);
