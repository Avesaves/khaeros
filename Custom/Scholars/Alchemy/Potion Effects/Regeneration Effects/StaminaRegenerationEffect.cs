...
{
	public class StaminaRegenerationEffect : CustomPotionEffect
	{
		...
		private static void ReleaseStamRegenLock( object state )
		{
			((Mobile)state).EndAction( typeof( StaminaRegenerationEffect ) );
		}

		public override string Name{ get{ return "Stamina Regeneration"; } }
		...
		{
			return mobile.CanBeginAction( typeof( StaminaRegenerationEffect ) );
		}
