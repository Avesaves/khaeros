...
{
	public class StrengthEffect : CustomPotionEffect
	{
		public override string Name{ get{ return "Strength"; } }
		...
		public override void ApplyEffect( Mobile to, Mobile source, int intensity, Item itemSource )
		{
			...
			if ( !Spells.SpellHelper.AddStatOffset( to, StatType.Str, ( curse ? -1 : 1 ) * ( BasePotion.Scale( to, offset ) ), duration ) )
