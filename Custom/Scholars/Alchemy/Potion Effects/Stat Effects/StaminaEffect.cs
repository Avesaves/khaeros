...
{
	public class StaminaEffect : CustomPotionEffect
	{
		public override string Name{ get{ return "Stamina"; } }
		...
		public override void ApplyEffect( Mobile to, Mobile source, int intensity, Item itemSource )
		{
			...
			if ( !Spells.SpellHelper.AddStatOffset( to, StatType.StamMax, ( curse ? -1 : 1 ) * ( BasePotion.Scale( to, offset ) ), duration ) )
