...
{
    public class LowQualityFireworks : Item, IEasyCraft
	{
		private FireworksTimer m_Timer;
		
		[Constructable]
		public LowQualityFireworks() : base( 3711 )
		{
			Hue = 38;
			Name = "low quality fireworks";
			Weight = 15.0;
		}

		public LowQualityFireworks( Serial serial ) : base( serial )
		{
		}
		...
		{
			private LowQualityFireworks m_Owner;
			private int m_Ticks;
			private bool m_IgniteCountdown;

			public FireworksTimer( LowQualityFireworks owner ) : base( TimeSpan.FromSeconds( 3.0 ), TimeSpan.FromSeconds( 1.0 ) )
			{
