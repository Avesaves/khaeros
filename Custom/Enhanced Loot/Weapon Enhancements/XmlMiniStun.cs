...
{
	public class XmlMiniStun : XmlAttachment
	{
		...
		public XmlMiniStun(ASerial serial) : base(serial)
		{
		}
		
		[Attachable]
		public XmlMiniStun() : this( 0.0, 0 )
		{
		}

		[Attachable]
		public XmlMiniStun(double duration, int chance)
		{
			m_Duration = duration;
			m_Chance = chance;
		}
		...
		public override void OnWeaponHit(Mobile attacker, Mobile defender, BaseWeapon weapon, int damageGiven)
		{
			...
			{
				XmlAttach.AttachTo( defender, new XmlParalyze(Duration) );
