...
namespace Server.FeatInfo
{
	public class Masterwork : BaseFeat
	{
        ...
        public override FeatList[] Allows { get { return new FeatList[] { FeatList.RenownedMasterwork, FeatList.Blunt, FeatList.Slashing, FeatList.Piercing, FeatList.Damage, FeatList.Speed, FeatList.HCI, FeatList.DCI}; } }
