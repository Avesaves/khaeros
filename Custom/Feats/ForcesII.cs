...
{
	public class ForcesII : BaseFeat
	{
		public override string Name{ get{ return "Forces II"; } }
		public override FeatList ListName{ get{ return Mobiles.FeatList.ForcesII; } }
		...
		public static void Initialize(){ WriteWebpage(new ForcesII()); }
