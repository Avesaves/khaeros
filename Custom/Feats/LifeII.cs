...
{
	public class LifeII : BaseFeat
	{
		public override string Name{ get{ return "Life II"; } }
		public override FeatList ListName{ get{ return Mobiles.FeatList.LifeII; } }
		...
		public override string FirstDescription{ get{ return "This skill will allow you to cast life-based spells from ancient " +
		...
		public static void Initialize(){ WriteWebpage(new LifeII()); }
