    ...
    public class SGGumpActivatorRemoval : Gump
    {
        ...
        public override void OnResponse(Server.Network.NetState sender, RelayInfo info)
        {
            ...
            switch (info.ButtonID)
            {
                case 0: // Remove
                    {
                        ...
                        {
                            from.SendMessage(77, "Artifact & Address removed from the Gate System...");
                        ...
                        {
                            from.SendMessage(77, "OPERATION ABORTED !!! Gate System Still ACTIVE, Gates can only be removed IF the Gate System is DISABLED.");
                ...
                case 1: // Exit
                    {
                        from.SendMessage(77, "Exit Gate Artifact Admin, this Artifact remains in the system.");
                    }
                    break;
            }
        }
