...
{
    public class SGTransportTile : Item
    {
        ...
        [Constructable]
        public SGTransportTile() : this(new Point3D(0, 0, 0), null, false)
        {
        }

        [Constructable]
        public SGTransportTile(Point3D pointDest, Map mapDest) : this(pointDest, mapDest, false)
        {
        }

        [Constructable]
        public SGTransportTile(Point3D pointDest, Map mapDest, bool creatures) : base(0x1BC3)
        {
            Movable = false;
            Visible = false;
        ...
        public virtual void DoTeleport(Mobile m)
        {
            ...
            m.MoveToWorld(p, map);
			m.SendMessage(33,"The air is whisked away from your lungs, and you feel drained of life!");
        ...
        public SGTransportTile(Serial serial) : base(serial)
        {
        }
