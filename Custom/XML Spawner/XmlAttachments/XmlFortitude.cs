...
{
    public class XmlFortitude : XmlAttachment
    {
        ...
        public XmlFortitude(ASerial serial) : base(serial)
        {
        }
        ...
        [Attachable]
        public XmlFortitude(int value)
        {
            m_Value = value;
        }
        
        [Attachable]
        public XmlFortitude(int value, double duration)
        {
            m_Value = value;
