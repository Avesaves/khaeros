...
namespace Server.Engines.XmlSpawner2
{
    public class XmlDialog : XmlAttachment
    {
        ...
        public new static void Initialize()
        {
            ...
            CommandSystem.Register( "SaveNPC", XmlSpawner.DiskAccessLevel, new CommandEventHandler( SaveNPC_OnCommand ) );
            CommandSystem.Register( "LoadNPC", XmlSpawner.DiskAccessLevel, new CommandEventHandler( LoadNPC_OnCommand ) );
        }
