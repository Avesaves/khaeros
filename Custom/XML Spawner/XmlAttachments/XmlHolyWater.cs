...
{
    public class XmlHolyWater : XmlAttachment
    {
        ...
        public XmlHolyWater(ASerial serial) : base(serial)
        {
        }
        ...
        [Attachable]
        public XmlHolyWater(int value)
        {
            m_Value = value;
        }
        
        [Attachable]
        public XmlHolyWater(int value, double duration)
        {
            m_Value = value;
