...
namespace Server.Items
{
	...
	public class SimpleLever : Item, ILinkable
	{
		...
		private int m_FirstID = 4236;
		private int m_SecondID = 4237;
		private int m_ThirdID = 4238;
		...
		public int FirstID{ get{ return m_FirstID; } set{ m_FirstID = value; } }
		
		[CommandProperty(AccessLevel.GameMaster)]
		public int SecondID{ get{ return m_SecondID; } set{ m_SecondID = value; } }
		
		[CommandProperty(AccessLevel.GameMaster)]
		public int ThirdID{ get{ return m_ThirdID; } set{ m_ThirdID = value; } }
		...
		public override void Serialize(GenericWriter writer)
		{
			...
			//version 3
			writer.Write( (int) m_FirstID );
			writer.Write( (int) m_SecondID );
			writer.Write( (int) m_ThirdID );
			// version 2
		...
		public override void Deserialize(GenericReader reader)
		{
			...
			switch (version)
			{
				case 3:
					{
						m_FirstID = reader.ReadInt();
						m_SecondID = reader.ReadInt();
						m_ThirdID = reader.ReadInt();
						goto case 2;
					}
				case 2:
					{
		...
		public void SetLeverStatic()
		{
			...
			else if( ( m_LeverState > 0 && m_LeverType == leverType.Two_State ) || m_LeverState > 1 )
				ItemID = m_ThirdID;
