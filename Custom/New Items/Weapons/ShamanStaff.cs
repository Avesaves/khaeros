...
{
	public class ShamanStaff : BaseStaff
	{
		public override string NameType{ get{ return "Shaman's Staff"; } }
		...
		[Constructable]
		public ShamanStaff() : base( 0x3DD1 )
		{
			Weight = 8.0;
			Name = "Shaman's Staff";
		...
		public ShamanStaff( Serial serial ) : base( serial )
		{
		}
