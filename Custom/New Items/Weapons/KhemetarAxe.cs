...
{
	public class KhemetarAxe : BaseAxe
	{
		public override string NameType{ get{ return "Khemetar Axe"; } }
		...
		[Constructable]
		public KhemetarAxe() : base( 0x3CB7)
		{
			Weight = 8.0;
			Name = "Khemetar Axe";
		...
		public KhemetarAxe( Serial serial ) : base( serial )
		{
		}
