...
{
	public class VhalurianMace : BaseBashing
	{
		public override string NameType{ get{ return "Vhalurian Mace"; } }
		...
		[Constructable]
		public VhalurianMace() : base( 0x3DED )
		{
			Weight = 6.0;
            Name = "Vhalurian Mace";
        ...
        public VhalurianMace(Serial serial)
            : base( serial )
		{
		}
