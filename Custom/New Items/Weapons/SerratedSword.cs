...
{
	public class SerratedSword : BaseSword
	{
		public override string NameType{ get{ return "Serrated Sword"; } }
		...
		[Constructable]
		public SerratedSword() : base( 0x3B2F )
		{
			Weight = 8.0;
			Name = "Serrated Sword";
		...
		public SerratedSword( Serial serial ) : base( serial )
		{
		}
