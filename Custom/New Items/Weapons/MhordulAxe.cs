...
{
	public class MhordulAxe : BaseAxe
	{
		public override string NameType{ get{ return "Mhordul Axe"; } }
		...
		public MhordulAxe( Serial serial ) : base( serial )
		{
		}
