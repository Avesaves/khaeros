...
{
	public class HeavyBattleHammer : BaseBashing
	{
		public override string NameType{ get{ return "heavy battle hammer"; } }
		...
		[Constructable]
		public HeavyBattleHammer() : base( 0x3DE5 )
		{
			Weight = 10.0;
		...
		public HeavyBattleHammer( Serial serial ) : base( serial )
		{
		}
