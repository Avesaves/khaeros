...
{
	public class GovernmentPlayerVendorDeed : Item
	{
		...
		[Constructable]
		public GovernmentPlayerVendorDeed( GovernmentEntity government ) : base( 0x14F0 )
		{
			Weight = 1.0;
		...
		public GovernmentPlayerVendorDeed( Serial serial ) : base( serial )
		{
		}
		...
		public override void OnDoubleClick( Mobile from )
		{
			...
			else if ( from.AccessLevel >= AccessLevel.GameMaster )
			{
				...
				Mobile v = new PlayerVendor( from, BaseHouse.FindHouseAt( from ), m_Government );
