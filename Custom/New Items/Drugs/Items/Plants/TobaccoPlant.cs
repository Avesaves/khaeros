...
{
	public class TobaccoPlant : BasePlant
	{
		public override Type Ingredient { get { return typeof( Tobacco ); } }

		[Constructable]
		public TobaccoPlant() : base( 0x0C63 )
		{
			Hue = 2976;
			Name = "tobacco plant";
		}
                ...
                if (!from.Mounted)
                {
                    ...
                    if (ingredient != null)
                    {
                        ...
                        if (successChance > Utility.RandomDouble())
                        {
                            ...
                            /* Seed.PickPlantSeed(from, "TobaccoPlant"); */
