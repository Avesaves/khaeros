...
namespace Knives.TownHouses
{
	...
	public class TownHouseSign : Item
	{
		...
		public bool LocSecReady{ get{ return ( BanReady ); } }
		...
		public void ShowSignPreview()
		{
			...
			Item sign = new Item( (Flip == true ? 0xBD2 : 0xBD1) );
		...
		public override void GetProperties( ObjectPropertyList list )
		{
			...
			//list.Add( 1060659, "Lockdowns\t{0}", c_Secures );
			//list.Add( 1060660, "Secures\t{0}", c_Locks );
