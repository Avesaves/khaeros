	...
	public class TownHouseConfirmGump : GumpPlusLight
	{
		...
		protected override void BuildGump()
		{
			...
			if ( c_Sign.RentByTime == TimeSpan.Zero )
				...
				AddHtml( 0, y+=25, width, String.Format( "<CENTER>{0}: {1}", "Tax " + c_Sign.PriceType, c_Sign.Price ));
			else
			...
			//EDITED
            AddHtml(0, y += 20, width, "<CENTER>Secures: " + c_Sign.Locks);
			AddHtml( 0, y+=20, width, "<CENTER>Lockdowns: " + c_Sign.Secures);
