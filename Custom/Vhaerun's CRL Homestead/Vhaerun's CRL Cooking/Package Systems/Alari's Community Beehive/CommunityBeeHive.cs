...
namespace Server.Items
{
	...
	{
		private int m_honey = 0, m_wax = 0; //  initial honey and wax.


		private static int min = 7, max = 11;	// min and max minutes. * CHANGE THESE *
							// NOTE: MINUTES. Will be multiplied by 60.

		// Modify MinSeconds and MaxSeconds on the object. Modify min and max in the script.
		private int m_minseconds = min * 60, m_maxseconds = max * 60;

		private int m_maxhoney = 10, m_maxwax = 10;   // adjust these as appropriate
		...
		[Constructable]
		public CommunityBeeHive() : base( 0x91a )
		{
		...
		public CommunityBeeHive( Serial serial ) : base( serial )
		{
		}
	...
	{
		public override BaseAddonDeed Deed{ get{ return new CommunityBeeHiveDeed(); } }
		...
		public CommunityBeeHiveAddon( Serial serial ) : base( serial )
		{
		}
	...
	{
		public override BaseAddon Addon{ get{ return new CommunityBeeHiveAddon(); } }
		...
		public CommunityBeeHiveDeed( Serial serial ) : base( serial )
		{
		}
	...
	public class CommunityBeeHiveTimer : Timer
	{
		...
		public CommunityBeeHiveTimer( CommunityBeeHive hive ) : base(
		...
		protected override void OnTick()
		{
			...
			if ( m_Beehive.StopTimer && m_Beehive.Honey >= m_Beehive.MaxHoney && m_Beehive.Wax >= m_Beehive.MaxWax )
				Stop();

			m_Beehive.PublicOverheadMessage( MessageType.Emote, 0x35, false, string.Format("Bzzzzzz" ));
