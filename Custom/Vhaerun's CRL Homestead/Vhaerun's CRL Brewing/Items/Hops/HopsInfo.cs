...
namespace Server.Items
{
	...
	public class BrewingResources
	{
		...
		{
			new HopsVarietyInfo( 0x4F3, 0,	"Bitter Hops",		HopsVariety.BitterHops,		typeof( BitterHops ) ),
	...
	//new HopsInfo (index, hue, name)
		public static readonly HopsInfo BitterHops	= new HopsInfo( 0, 0x4F3, "Bitter Hops" );
