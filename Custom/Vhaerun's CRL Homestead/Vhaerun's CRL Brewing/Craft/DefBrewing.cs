...
namespace Server.Engines.Craft
{
	public class DefBrewing : CraftSystem
	{
		...
		public override void InitCraftList()
		{
			...
			index = AddCraft( typeof( MeadKeg ), "Mead", "Keg of Mead", 20.0, 35.6, typeof( BitterHops ), "Bitter Hops", 50 );
			AddRes( index, typeof( Keg ), "Keg", 1 );
			AddRes( index, typeof( BaseBeverage ), "Water", 20 );
			AddRes( index, typeof( BagOfMalt ), "Bag of Malt", 3 );
			SetNeedOven( index, true );

			/* Ale */

			index = AddCraft( typeof( AleKeg ), "Ale", "Keg of Ale", 20.0, 35.6, typeof( BitterHops ), "Bitter Hops", 50 );
			AddRes( index, typeof( Keg ), "Keg", 1 );
			AddRes( index, typeof( BaseBeverage ), "Water", 20 );
			AddRes( index, typeof( BagOfBarley ), "Bag of Barley", 3 );
			SetNeedOven( index, true );

			/* Cider */

			index = AddCraft( typeof( CiderKeg ), "Cider", "Keg of Cider", 20.0, 35.6, typeof( Keg ), "Keg", 1 );
			...
			// This will overide the overidable material
           		...
           		AddSubRes( typeof( BitterHops ), 	"Bitter Hops", 20.0, skillNotice);
            		AddSubRes( typeof( SnowHops ), 		"Snow Hops", 20.0, skillNotice);
            		//AddSubRes( typeof( ElvenHops ), 	"Elven Hops", 80.0, skillNotice);
            		AddSubRes( typeof( SweetHops ), 	"Sweet Hops", 20.0, skillNotice);
