...
namespace Server.Items.Crops
{
	public class DatePalm : Item
	{
			...
			if ( DateTime.Now > lastpicked.AddSeconds(3) ) // 3 seconds between picking
			{
				...
				{ 
					...
					else //check skill
					{
                        ...
                        Seed.PickCropSeed(from, "DatePalm");
		...
		private class FruitTimer : Timer
		{
			...
			public FruitTimer( DatePalm plant ) : base( TimeSpan.FromSeconds( 1200 ), TimeSpan.FromSeconds( 45 ) )
			{
