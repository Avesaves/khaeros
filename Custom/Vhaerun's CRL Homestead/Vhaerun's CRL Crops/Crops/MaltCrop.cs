...
{
    public class MaltSeed : BaseCrop
    {
        ...
        public override void OnDoubleClick( Mobile from )
        {
            ...
            this.Consume();
            Item item = new MaltSeedling( from );
            item.Location = m_pnt;
            item.Map = m_map;

        }

        public MaltSeed( Serial serial )
            : base( serial )
        {
        }
    ...
    public class MaltSeedling : BaseCrop
    {
        ...
        [Constructable]
        public MaltSeedling( Mobile sower )
        ...
        public static void init( MaltSeedling plant )
        {
            plant.thisTimer = new CropHelper.GrowTimer( plant, typeof( MaltCrop ), plant.Sower );
        ...
        public MaltSeedling( Serial serial )
            : base( serial )
        {
        }
    ...
    public class MaltCrop : BaseCrop
    {
        ...
        public static void init( MaltCrop plant, bool full )
        {
            ...
            if( DateTime.Now > lastpicked.AddSeconds( 3 ) ) // 3 seconds between picking
            {
                ...
                if( from.InRange( this.GetWorldLocation(), 1 ) )
                {
                    ...
                    else //check skill and sower
                    {
                        ...
                        Seed.PickCropSeed(from, "MaltCrop");
                        ...
                        MaltSheath crop = new MaltSheath( pick );
        ...
        {
            private MaltCrop i_plant;

            public CropTimer( MaltCrop plant )
