...
{
    public class BarleySeed : BaseCrop
    {
        ...
        public BarleySeed( Serial serial )
            : base( serial )
        {
        }
    ...
    public class BarleySeedling : BaseCrop
    {
        ...
        [Constructable]
        public BarleySeedling( Mobile sower )
            : base( Utility.RandomList( 0xDAE, 0xDAF ) )
        {
            Movable = false;
            Name = "Barley Seedling";
            m_sower = sower;
        ...
        public BarleySeedling( Serial serial )
            : base( serial )
        {
        }
    ...
    public class BarleyCrop : BaseCrop
    {
        ...
        [Constructable]
        public BarleyCrop( Mobile sower )
        ...
        public static void init( BarleyCrop plant, bool full )
        {
            ...
            if( DateTime.Now > lastpicked.AddSeconds( 3 ) ) // 3 seconds between picking
            {
                ...
                if( from.InRange( this.GetWorldLocation(), 1 ) )
                {
                    ...
                    else //check skill and sower
                    {
                        ...
                        Seed.PickCropSeed(from, "BarleyCrop");
                        ...
                        BarleySheath crop = new BarleySheath( pick );
        ...
        {
            private BarleyCrop i_plant;

            public CropTimer( BarleyCrop plant )
        ...
        public BarleyCrop( Serial serial )
            : base( serial )
        {
        }
