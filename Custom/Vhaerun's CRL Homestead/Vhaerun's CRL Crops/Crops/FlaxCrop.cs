	...
	{ 
		...
		{ 
			...
			if ( from is PlayerMobile  )
			{
				...
				{
					from.SendMessage( "You do not know how to plant that seed." ); 
					return; 
				}
			}
	...
	{ 
		...
		{ 
			...
			if ( DateTime.Now > lastpicked.AddSeconds(3) ) // 3 seconds between picking
			{
				...
				int tailorValue = Math.Max( 2, ((int)(from.Skills[SkillName.Peacemaking].Base * 0.1)) );
				if ( tailorValue == 0 )
				{
				...
				{ 
					...
					else //check skill and sower
					{
                        ...
                        Seed.PickCropSeed(from, "FlaxCrop");
