...
namespace Server.Items.Crops
{
	...
	public class PineappleTree : Item
	{
		...
		[Constructable] 
		public PineappleTree() : base( 0xCAA ) 
		{
			Movable = false;
			init( this, false );
		}
			...
			if ( DateTime.Now > lastpicked.AddSeconds(3) ) // 3 seconds between picking
			{
				...
				{ 
					...
					else //check skill
					{
                        ...
                        Seed.PickCropSeed(from, "PineappleTree");
		...
		private class FruitTimer : Timer
		{
			...
			public FruitTimer( PineappleTree plant ) : base( TimeSpan.FromSeconds( 1200 ), TimeSpan.FromSeconds( 45 ) )
			{
