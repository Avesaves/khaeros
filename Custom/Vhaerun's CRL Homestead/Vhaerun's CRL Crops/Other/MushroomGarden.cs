	...
	public class MushroomAddon : AddonComponent
	{
		...
		public override void OnDoubleClick( Mobile from )
		{
			...
			{ 
				...
				else if ( from.CheckTargetSkill( SkillName.HerbalLore, this, 0, 25 ) )
				{
					if(from.Skills[SkillName.HerbalLore].Base<50)
					{
						from.AddToBackpack( new Mushrooms( this.ItemID ) );
						from.SendMessage( "You find some edible mushrooms!" );
						
					}
					else if(from.Skills[SkillName.HerbalLore].Base>=50)
					{
