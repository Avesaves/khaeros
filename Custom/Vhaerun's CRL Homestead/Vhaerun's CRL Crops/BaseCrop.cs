...
namespace Server.Items
{
 	public abstract class BaseCrop : Item
 	{
        ...
        public static bool IsPlant(string parent)
        {
            switch (parent)
            {
                case "QatPlant":
                ...
                case "CamphorTree":
                case "Wormwood": return true;
            }

            return false;
        }

        public static bool IsCrop(string parent)
        {
            switch (parent)
            {
                case "AlmondTree":
