...
namespace Server.Engines.Harvest
{
	public class HerbGathering : HarvestSystem
	{
		...
		private HerbGathering()
		{
			...
			herb.OutOfRangeMessage = 500446; // That is too far away.
			...
			veins = new HarvestVein[]
				{
					new HarvestVein( 5.0, 0.0, res[0], null ), // sage
					new HarvestVein( 1.5, 0.1, res[1], res[0] ), // acacia
					new HarvestVein( 3.0, 0.1, res[2], res[0] ), // anise
					new HarvestVein( 3.0, 0.1, res[3], res[0] ), // basil
					new HarvestVein( 3.0, 0.1, res[4], res[0] ), // bay leaf
					new HarvestVein( 3.0, 0.1, res[5], res[0] ), // chamomile
					new HarvestVein( 3.0, 0.1, res[6], res[0] ), // caraway
					new HarvestVein( 3.0, 0.1, res[7], res[0] ), // cilantro
					new HarvestVein( 3.0, 0.1, res[8], res[0] ), // cinnamon
					new HarvestVein( 3.0, 0.1, res[9], res[0] ), // clove
					new HarvestVein( 1.5, 0.1, res[10], res[0] ), // copal
					new HarvestVein( 3.0, 0.1, res[11], res[0] ), // coriander
					new HarvestVein( 3.0, 0.1, res[12], res[0] ), // dill
					new HarvestVein( 1.5, 0.1, res[13], res[0] ), // dragonsblood
					new HarvestVein( 1.5, 0.1, res[14], res[0] ), // frankincense
					new HarvestVein( 3.0, 0.1, res[15], res[0] ), // lavender
					new HarvestVein( 1.5, 0.1, res[16], res[0] ), // marjoram
					new HarvestVein( 3.0, 0.1, res[17], res[0] ), // meadowsweet
					new HarvestVein( 5.0, 0.1, res[18], res[0] ), // mint
					new HarvestVein( 3.0, 0.1, res[19], res[0] ), // mugwort
					new HarvestVein( 3.0, 0.1, res[20], res[0] ), // mustard
					new HarvestVein( 1.5, 0.1, res[21], res[0] ), // myrrh
					new HarvestVein( 3.0, 0.1, res[22], res[0] ), // olive
					new HarvestVein( 5.0, 0.1, res[23], res[0] ), // oregano
					new HarvestVein( 1.5, 0.1, res[24], res[0] ), // orris
					new HarvestVein( 1.5, 0.1, res[25], res[0] ), // patchouli
					new HarvestVein( 5.0, 0.1, res[26], res[0] ), // peppercorn
					new HarvestVein( 3.0, 0.1, res[27], res[0] ), // roseherb
					new HarvestVein( 3.0, 0.1, res[28], res[0] ), // rosemary
					new HarvestVein( 3.0, 0.1, res[29], res[0] ), // saffron
					new HarvestVein( 1.5, 0.1, res[30], res[0] ), // sandelwood
					new HarvestVein( 3.0, 0.1, res[31], res[0] ), // slipperyelm
					new HarvestVein( 5.0, 0.1, res[32], res[0] ), // thyme
					new HarvestVein( 1.5, 0.1, res[33], res[0] ), // valerian
		...
		public override bool CheckHarvest( Mobile from, Item tool )
		{
			...
			if ( tool.Parent != from )
			{
				from.SendMessage( "You must be holding the boline for gathering herbs." );
				return false;
			}
