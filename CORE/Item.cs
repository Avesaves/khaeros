...
namespace Server
{
	...
	public class Item : IPoint3D, IEntity, IHued, IComparable, IComparable<Item>, IComparable<IEntity>, ISerializable
	{
        ...
        {
            get{ return m_CanBeGrabbed; }
            set{ m_CanBeGrabbed = value; }
        }
		...
		public virtual void AddResistanceProperties( ObjectPropertyList list )
		{
			...
			if ( v != 0 )
				list.Add( "physical resistance {0}%", v.ToString() ); // physical resist ~1_val~%

			v = FireResistance;

			if ( v != 0 )
				list.Add( "fire resistance {0}%", v.ToString() ); // fire resist ~1_val~%

			v = ColdResistance;

			if ( v != 0 )
				list.Add( "cold resistance {0}%", v.ToString() ); // cold resist ~1_val~%
			...
			if ( v != 0 )
				list.Add( "blunt resistance {0}%", v.ToString() ); // cold resist ~1_val~%
           
            v = SlashingResistance;

			if ( v != 0 )
				list.Add( "slashing resistance {0}%", v.ToString() ); // cold resist ~1_val~%

            v = PiercingResistance;

			if ( v != 0 )
				list.Add( "piercing resistance {0}%", v.ToString() ); // cold resist ~1_val~%
		...
		public virtual void Serialize( GenericWriter writer )
		{
            ...
            writer.Write( (bool) m_CanBeGrabbed );
		...
		public virtual void Deserialize( GenericReader reader )
		{
			...
			switch ( version )
			{
				case 11:
                {
					m_CanBeGrabbed = reader.ReadBool();
      ...
      public virtual void OnAfterDuped( Item newItem )
      {
        ...
        public virtual int BluntResistance{ get{ return 0; } }
        public virtual int SlashingResistance { get { return 0; } }
        public virtual int PiercingResistance{ get{ return 0; } }
		...
		public virtual void OnPlacedForSale( Mobile vendor )
		{
		}
		
		public virtual void OnRemovedFromSale( Mobile vendor )
		{
		}
		
		public virtual void OnPurchased( Mobile vendor, Mobile buyer )
		{
		}
