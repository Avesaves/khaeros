...
namespace Server.Spells
{
	public abstract class Spell : ISpell
	{
		...
		public virtual SkillName DamageSkill{ get{ return SkillName.Invocation; } }
		...
		*/
		...
		public virtual TimeSpan GetCastDelay()
		{
			...
			if ( CastSkill == SkillName.Faith && m_Caster.Skills[SkillName.Magery].Value < 70.0 )
				fcMax = 4;
			...
			else if ( CheckFizzle() )
			{
				...
				if ( TransformationSpell.UnderTransformation( m_Caster, typeof( VampiricEmbraceSpell ) ) )
				{
					...
					if ( garlic )
					{
						...
						AOS.Damage( m_Caster, Utility.RandomMinMax( 17, 23 ), 100, 0, 0, 0, 0, 0, 0, 0 );
					}
				}
