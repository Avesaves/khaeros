		...
		public static void Initialize()
		{
			...
			if ( Core.AOS )
			{
				...
				if ( Core.SE )
				{
					...
					// Ninja abilities
					Register( 500, typeof( ExoticWeaponry.FocusAttack ) );
					Register( 501, typeof( ExoticWeaponry.DeathStrike ) );
					Register( 502, typeof( ExoticWeaponry.AnimalForm ) );
					Register( 503, typeof( ExoticWeaponry.KiAttack ) );
					Register( 504, typeof( ExoticWeaponry.SurpriseAttack ) );
					Register( 505, typeof( ExoticWeaponry.Backstab ) );
					Register( 506, typeof( ExoticWeaponry.Shadowjump ) );
					Register( 507, typeof( ExoticWeaponry.MirrorImage ) );
				}
			}
		}
