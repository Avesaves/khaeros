...
namespace Server.Spells.ExoticWeaponry
{
	public abstract class NinjaSpell : Spell
	{
		...
		public override SkillName CastSkill{ get{ return SkillName.ExoticWeaponry; } }
		...
		public override bool CheckFizzle()
		{
			...
			if ( Caster.Skills[CastSkill].Value < RequiredSkill )
			{
				Caster.SendLocalizedMessage( 1063352, RequiredSkill.ToString( "F1" ) ); // You need ~1_SKILL_REQUIREMENT~ ExoticWeaponry skill to perform that attack!
				return false;
			}
