...
namespace Server.Spells.Necromancy
{
		...
		private static SummonFamiliarEntry[] m_Entries = new SummonFamiliarEntry[]
			{
				...
				new SummonFamiliarEntry( typeof( WanderingSpiritFamiliar ), 1060142,  50.0,  50.0 ), // Shadow Wisp
	...
	public class SummonFamiliarGump : Gump
	{
		...
		public SummonFamiliarGump( Mobile from, SummonFamiliarEntry[] entries, SummonFamiliarSpell spell ) : base( 200, 100 )
		{
			...
			double necro = from.Skills[SkillName.Polearms].Base;
			double spirit = from.Skills[SkillName.Linguistics].Base;
		...
		public override void OnResponse( NetState sender, RelayInfo info )
		{
			...
			if ( index >= 0 && index < m_Entries.Length )
			{
				...
				double necro = m_From.Skills[SkillName.Polearms].Base;
				double spirit = m_From.Skills[SkillName.Linguistics].Base;
