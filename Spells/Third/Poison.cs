		...
		public void Target( Mobile m )
		{
			...
			else if ( CheckHSequence( m ) )
			{
				...
				else
				{
					...
					Dictionary<PoisonEffectEnum, int> dict = new Dictionary<PoisonEffectEnum, int>();
					dict[PoisonEffectEnum.DamageHealth] = level*10 + 10;
					PoisonEffect.Poison( m, Caster, dict, 180, 4, false ); 
				}
