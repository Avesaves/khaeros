...
namespace Server.Engines.Harvest
{
	public class Fishing : HarvestSystem
	{
			...
			res = new HarvestResource[]
				{
					...
					//new HarvestResource ( 10.0, -15.0, 100.0 "Tuna", typeof( Tuna ) ),
					//new HarvestResource ( 10.0, -15.0, 100.0 "Perch", typeof(Perch)),
				   // new HarvestResource ( 10.0, -15.0, 100.0 "Carp", typeof(Carp)),
					//new HarvestResource ( 10.0, -15.0, 100.0 "Catfish", typeof(Catfish))
				};

			veins = new HarvestVein[]
				{
					new HarvestVein( 100.0, 0.0,  res[0], null ),   //Tuna
					//new HarvestVein( 25.0, 0.5, res[2], res[0] ),   //perch
					//new HarvestVein( 25.0, 0.5, res[3], res[0] ),   //carp
					//new HarvestVein( 25.0, 0.5, res[4], res[0] )  //catfish
				};
		...
		private static MutateEntry[] m_MutateTable = new MutateEntry[]
			{
				...
				new MutateEntry(  90.0,  125.0,  -2375.0,  false, typeof( BigFish ) ),
		...
		public override void SendSuccessTo( Mobile from, Item item, HarvestResource resource )
		{
			...
			{
				m.Crafting = true;	
				LevelSystem.AwardMinimumXP( m, 2 );
				m.Crafting = false;
			}
