		...
		public void DoDamage( Mobile to )
		{
			switch ( Utility.Random( 4 ) )
			{
				...
				case 1:
				{
					...
					AOS.Damage( to, to, Utility.RandomMinMax( 10, 40 ), 0, 100, 0, 0, 0, 0, 0, 0 );
				...
				case 2:
				{
					...
					AOS.Damage( to, to, Utility.RandomMinMax( 10, 40 ), 100, 0, 0, 0, 0, 0, 0, 0 );
				...
				default:
				{
					...
					AOS.Damage( to, to, Utility.RandomMinMax( 10, 40 ), 0, 0, 0, 0, 100, 0, 0, 0 );
