...
//			dealer.RangeHome = 2;
		...
		public static void GenGauntlet_OnCommand( CommandEventArgs e )
		{
			...
			GauntletSpawner sp1 = CreateSpawner( "Quaraphon",		491, 456,	473, 432,	417, 426,	true,	473, 412, 39, 60 );
			GauntletSpawner sp2 = CreateSpawner( "DuneDigger",			482, 520,	468, 496,	426, 422,	false,	448, 496, 56, 48 );
			GauntletSpawner sp3 = CreateSpawner( "HookHorror",					406, 538,	408, 504,	432, 430,	false,	376, 504, 64, 48 );
			GauntletSpawner sp4 = CreateSpawner( "ShadowKnight",			335, 512,	360, 478,	424, 439,	false,	300, 478, 72, 64 );
			GauntletSpawner sp5 = CreateSpawner( "Octopod",			326, 433,	360, 429,	416, 435,	true,	300, 408, 60, 56 );
