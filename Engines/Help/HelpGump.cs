...
namespace Server.Engines.Help
{
	...
	public class HelpGump : Gump
	{
		...
		public HelpGump( Mobile from ) : base( 0, 0 )
		{
			...
			AddHtml( 150, 50, 360, 40, "<CENTER><U>Khaeros Help Menu</U></CENTER>", false, false ); // <CENTER><U>Ultima Online Help Menu</U></CENTER>
			...
			AddPage( 1 );
				...
				AddHtml( 110, 170, 450, 74, @"<u>My character is physically stuck in the game.</u> This choice only covers cases where your character is physically stuck in a location they cannot move out of.", true, true );
				
				AddButton( 80, 250, 5540, 5541, 6, GumpButtonType.Reply, 0 );
				AddHtml( 110, 250, 450, 74, @"<u>Page an OS.</u> If you are experiencing a problem in the game that is not addressed on the Forums and requires in-game assistance, use this option. ", true, true );
