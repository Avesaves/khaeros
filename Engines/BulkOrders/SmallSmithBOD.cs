	...
	public class SmallSmithBOD : SmallBOD
	{
		...
		public static SmallSmithBOD CreateRandomFor( Mobile m )
		{
			...
			if ( entries.Length > 0 )
			{
				...
				if ( useMaterials && theirSkill >= 70.1 )
				{
					for ( int i = 0; i < 20; ++i )
					{
						BulkMaterialType check = GetRandomMaterial( BulkMaterialType.Copper, m_BlacksmithMaterialChances );
						double skillReq = 0.0;
						...
						switch ( check )
						{
							...
							case BulkMaterialType.Silver: skillReq = 90.0; break;
							case BulkMaterialType.Tin: skillReq = 65.0; break;
							case BulkMaterialType.Obsidian: skillReq = 95.0; break;
							case BulkMaterialType.Steel: skillReq = 100.0; break;
							case BulkMaterialType.Thick: skillReq = 65.0; break;
							case BulkMaterialType.Beast: skillReq = 80.0; break;
							case BulkMaterialType.Scaled: skillReq = 99.0; break;
						}
		...
		public SmallSmithBOD()
		{
			...
			if ( entries.Length > 0 )
			{
				...
				if ( useMaterials )
					material = GetRandomMaterial( BulkMaterialType.Copper, m_BlacksmithMaterialChances );
				else
