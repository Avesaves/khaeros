	...
	public class SmallTailorBOD : SmallBOD
	{
		...
		public static SmallTailorBOD CreateRandomFor( Mobile m )
		{
			...
			if ( entries.Length > 0 )
			{
				...
				if ( useMaterials && theirSkill >= 70.1 )
				{
					for ( int i = 0; i < 20; ++i )
					{
						BulkMaterialType check = GetRandomMaterial( BulkMaterialType.Thick, m_TailoringMaterialChances );
						double skillReq = 0.0;
						...
						switch ( check )
						{
							...
							case BulkMaterialType.Tin: skillReq = 75.0; break;
		...
		public SmallTailorBOD()
		{
			...
			if ( entries.Length > 0 )
			{
				...
				if ( useMaterials )
					material = GetRandomMaterial( BulkMaterialType.Thick, m_TailoringMaterialChances );
				else
